...
// ═══════════════════════════════════════════
const scenarios = [
  { id: "scenario-eva-tomanova", title: "Zahraniční majitel", description: "Eva žije v zahraničí a potřebuje prodat zděděný byt na dálku.", category: "hot-lead", difficulty: "easy", objectives: ["Zdůraznit vzdálený prodej", "Vysvětlit plnou moc", "Navrhnout video call", "Domluvit termín"], agent_id: "agent-eva-tomanova", image_url: "/scenarios/eva-email.png" },
  { id: "scenario-karin-horackova", title: "Doporučení od známého", description: "Karin volá díky doporučení od spokojeného zákazníka.", category: "hot-lead", difficulty: "easy", objectives: ["Zmínit doporučujícího", "Poděkovat za důvěru", "Přejít k věci", "Domluvit schůzku"], agent_id: "agent-karin-horackova", image_url: "/scenarios/karin-h-doporuceni.png" },
  { id: "scenario-karin-pitrova", title: "Návrat po čase", description: "Karin volá po 6 měsících, teď je připravená prodávat.", category: "hot-lead", difficulty: "easy", objectives: ["Navázat na CRM", "Zjistit změny", "Jednat rozhodně", "Domluvit schůzku"], agent_id: "agent-karin-pitrova", image_url: "/scenarios/karin-p-crm.png" },
  { id: "scenario-samuel-orel", title: "Kulový blesk: prodej i koupě", description: "Samuel potřebuje prodat i koupit současně.", category: "hot-lead", difficulty: "easy", objectives: ["Vysvětlit provázání časů", "Nabídnout hypoteční poradenství", "Prokázat koordinaci", "Domluvit schůzku"], agent_id: "agent-samuel-orel", image_url: "/scenarios/samuel-hovor.png" },
  { id: "scenario-milada-kejvalova", title: "Návrat po čase (opatrná)", description: "Milada volá po 6 měsících, stěhuje se do zahraničí.", category: "hot-lead", difficulty: "easy", objectives: ["Navázat na CRM", "Zvládnout námitku", "Prokázat zkušenost", "Domluvit schůzku"], agent_id: "agent-milada-kejvalova", image_url: "/scenarios/milada-crm.png" },
  { id: "scenario-adam-kohout", title: "Výběrové řízení", description: "Adam porovnává makléře a chce vědět proč si vybrat vás.", category: "warm-lead", difficulty: "easy", objectives: ["Nehanit konkurenci", "Přinést reference", "Nabídnout analýzu", "Domluvit odhad"], agent_id: "agent-adam-kohout", image_url: "/scenarios/adam-email.png" },
  { id: "scenario-hildegarda-kovarova", title: "Sondování trhu", description: "Hildegarda se jen ptá na cenu, zatím neprodává.", category: "warm-lead", difficulty: "easy", objectives: ["Nevyvíjet tlak", "Nabídnout odhad", "Domluvit follow-up", "Udržet v CRM"], agent_id: "agent-hildegarda-kovarova", image_url: "/scenarios/hildegarda-portal.png" },
  { id: "scenario-ruzena-ruzickova", title: "Dotaz ze sociálních sítí", description: "Růžena komentovala FB příspěvek a napsala zprávu.", category: "warm-lead", difficulty: "medium", objectives: ["Zmínit komentář", "Odpovědět s daty", "Zjistit záměr", "Přejít ke schůzce"], agent_id: "agent-ruzena-ruzickova", image_url: "/scenarios/ruzena-facebook.png" },
  { id: "scenario-leos-musil", title: "Reakce na leták", description: "Leoš zavolal na číslo z letáku, je skeptický.", category: "warm-lead", difficulty: "medium", objectives: ["Ocenit zavolání", "Připomenout leták", "Nabídnout setkání", "Domluvit odhad"], agent_id: "agent-leos-musil", image_url: "/scenarios/leos-letak.png" },
  { id: "scenario-eduard-langer", title: "Follow-up po cold e-mailu", description: "Eduard dostal e-mail před 2 týdny a neodpověděl.", category: "cold-lead", difficulty: "medium", objectives: ["Zmínit e-mail", "Být krátký", "Dát out", "Zjistit zájem"], agent_id: "agent-eduard-langer", image_url: "/scenarios/eduard-cold-email.png" },
  { id: "scenario-ilona-tykalova", title: "Slepé volání podle katastru", description: "Číslo dohledáno z katastru, klientka reaguje podezřívavě.", category: "cold-lead", difficulty: "medium", objectives: ["Být upřímný", "Říct proč voláte", "Přejít k hodnotě", "Překonat odpor"], agent_id: "agent-ilona-tykalova", image_url: "/scenarios/ilona-katastr.png" },
  { id: "scenario-leona-neumannova", title: "Exspirace inzerátu", description: "Leoně vypršel inzerát po 3 měsících bez prodeje.", category: "cold-lead", difficulty: "medium", objectives: ["Neříkat neprodalo se", "Nabídnout analýzu", "Navrhnout změny", "Domluvit schůzku"], agent_id: "agent-leona-neumannova", image_url: "/scenarios/leona-inzerat.png" },
  { id: "scenario-miroslava-balounova", title: "B2B akvizice", description: "B2B cold call na správce bytového fondu.", category: "cold-lead", difficulty: "medium", objectives: ["Zjistit decision makera", "Mluvit o úspoře", "Nabídnout audit", "Dostat se dál"], agent_id: "agent-miroslava-balounova", image_url: "/scenarios/miroslava-b2b.png" },
  { id: "scenario-ales-navratil", title: "Samoprodejce (FSBO)", description: "Aleš prodává sám přes inzertní portály.", category: "cold-lead", difficulty: "hard", objectives: ["Překonat odmítání", "Prokázat hodnotu", "Ukázat data", "Domluvit krok"], agent_id: "agent-ales-navratil", image_url: "/scenarios/ales-inzerat.png" },
  { id: "scenario-andrea-kohoutova", title: "B2B akvizice developer", description: "B2B cold call na správce/developera.", category: "cold-lead", difficulty: "hard", objectives: ["Prokázat hodnotu", "Přežít odmítnutí", "Dostat se k decision makerovi", "Nabídnout pilotní spolupráci"], agent_id: "agent-andrea-kohoutova", image_url: "/scenarios/andrea-k-developer.png" },
  { id: "scenario-agata-kralova", title: "Samoprodejce (FSBO) ledový mur", description: "Agáta prodává sama, minimum času, přímý styl.", category: "cold-lead", difficulty: "hard", objectives: ["Být stručný", "Prolomit led hodnotou", "Respektovat čas", "Domluvit krok"], agent_id: "agent-agata-kralova", image_url: "/scenarios/agata-inzerat.png" },
  { id: "scenario-andrea-spackova", title: "Follow-up po e-mailu (tichý typ)", description: "Andrea dostala cold e-mail, odpovídá krátce a stroze.", category: "cold-lead", difficulty: "hard", objectives: ["Zmínit e-mail", "Dát out", "Nenutit k rozhovoru", "Domluvit krok"], agent_id: "agent-andrea-spackova", image_url: "/scenarios/eduard-cold-email.png" },
  { id: "scenario-marie-mrazkova", title: "Follow-up po e-mailu (paranoidní)", description: "Marie je paranoidní a podezřívá ze skrytých motivů.", category: "cold-lead", difficulty: "hard", objectives: ["Zmínit e-mail", "Prokázat důvěryhodnost", "Dát out", "Posunout věci"], agent_id: "agent-marie-mrazkova", image_url: "/scenarios/eduard-cold-email.png" },
  { id: "scenario-frantiska-jelinkova", title: "Exspirace inzerátu (nejtěžší)", description: "Františce vypršel inzerát přes jinou RK, obtížnost 10/10.", category: "cold-lead", difficulty: "hard", objectives: ["Neříkat o neúspěchu", "Nabídnout analýzu", "Navrhnout změny", "Získat souhlas"], agent_id: "agent-frantiska-jelinkova", image_url: "/scenarios/frantiska-inzerat.png" },
];
