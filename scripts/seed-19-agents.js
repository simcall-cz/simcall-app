 ...
 * 
 * DŮLEŽITÉ: Nahraďte 'PLACEHOLDER' za skutečné ElevenLabs Agent IDs!
 * 
...
// ═══════════════════════════════════════════
// AGENTI — vyplňte ElevenLabs Agent IDs
// ═══════════════════════════════════════════
const agents = [
  { id: "agent-eva-tomanova", name: "Eva Tomanová", personality: "Sociální typ", description: "Zahraniční majitelka, HOT lead, obtížnost 1", difficulty: "easy", avatar_initials: "ET", traits: ["Přátelská", "Sdílná", "Nadšená", "Zvědavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-karin-horackova", name: "Karin Horáčková", personality: "Přátelská ale nezávazná", description: "Doporučení od známého, HOT lead, obtížnost 1", difficulty: "easy", avatar_initials: "KH", traits: ["Přátelská", "Otevřená", "Nezávazná", "Trpělivá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-karin-pitrova", name: "Karin Pitrová", personality: "Dominantní expert", description: "Návrat po čase, HOT lead, obtížnost 1", difficulty: "easy", avatar_initials: "KP", traits: ["Dominantní", "Sebevědomá", "Odborná", "Rozhodná"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-samuel-orel", name: "Samuel Orel", personality: "Dominantní expert", description: "Prodej i koupě, HOT lead, obtížnost 1", difficulty: "easy", avatar_initials: "SO", traits: ["Dominantní", "Sebevědomý", "Analytický", "Přímý"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-milada-kejvalova", name: "Milada Kejvalová", personality: "Přátelská ale opatrná", description: "Návrat po čase, HOT lead, obtížnost 2", difficulty: "easy", avatar_initials: "MK", traits: ["Přátelská", "Opatrná", "Formální", "Zvědavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-adam-kohout", name: "Adam Kohout", personality: "Přepečlivý perfekcionista", description: "Výběrové řízení, WARM lead, obtížnost 3", difficulty: "easy", avatar_initials: "AK", traits: ["Perfekcionista", "Opatrný", "Zvědavý", "Váhavý"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-hildegarda-kovarova", name: "Hildegarda Kovářová", personality: "Nedůvěřivá paranoidní", description: "Sondování trhu, WARM lead, obtížnost 3", difficulty: "easy", avatar_initials: "HK", traits: ["Nedůvěřivá", "Paranoidní", "Opatrná", "Podezřívavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-ruzena-ruzickova", name: "Růžena Růžičková", personality: "Sociální typ", description: "Dotaz ze soc. sítí, WARM lead, obtížnost 4", difficulty: "medium", avatar_initials: "RR", traits: ["Sociální", "Hodnotící", "Věcná", "Váhavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-leos-musil", name: "Leoš Musil", personality: "Skeptický realista", description: "Reakce na leták, WARM lead, obtížnost 4", difficulty: "medium", avatar_initials: "LM", traits: ["Skeptický", "Realistický", "Přímý", "Rozhodný"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-eduard-langer", name: "Eduard Langer", personality: "Nedůvěřivý paranoidní", description: "Follow-up po e-mailu, COLD lead, obtížnost 5", difficulty: "medium", avatar_initials: "EL", traits: ["Nedůvěřivý", "Paranoidní", "Opatrný", "Skeptický"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-ilona-tykalova", name: "Ilona Tykalová", personality: "Přátelská ale nezávazná", description: "Slepé volání z katastru, COLD lead, obtížnost 5", difficulty: "medium", avatar_initials: "IT", traits: ["Přátelská", "Nezávazná", "Podezřívavá", "Opatrná"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-leona-neumannova", name: "Leona Neumannová", personality: "Chronická vyjednavačka", description: "Exspirace inzerátu, COLD lead, obtížnost 6", difficulty: "medium", avatar_initials: "LN", traits: ["Vyjednávačka", "Přímá", "Skeptická", "Nátlaková"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-miroslava-balounova", name: "Miroslava Balounová", personality: "Chronická vyjednavačka", description: "B2B akvizice, COLD lead, obtížnost 6", difficulty: "medium", avatar_initials: "MB", traits: ["Vyjednávačka", "Formální", "Odmítavá", "Skeptická"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-ales-navratil", name: "Aleš Navrátil", personality: "Pesimista", description: "Samoprodejce FSBO, COLD lead, obtížnost 7", difficulty: "hard", avatar_initials: "AN", traits: ["Pesimistický", "Odmítavý", "Nedůvěřivý", "Přímý"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-andrea-kohoutova", name: "Andrea Kohoutová", personality: "Nedůvěřivá paranoidní", description: "B2B akvizice developer, COLD lead, obtížnost 8", difficulty: "hard", avatar_initials: "AKo", traits: ["Paranoidní", "Odmítavá", "Nedůvěřivá", "Přímá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-agata-kralova", name: "Agáta Králová", personality: "Zaneprázdněný manažer", description: "Samoprodejce FSBO, COLD lead, obtížnost 9", difficulty: "hard", avatar_initials: "AKr", traits: ["Zaneprázdněná", "Přímá", "Netrpělivá", "Odmítavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-andrea-spackova", name: "Andrea Špačková", personality: "Tichý typ", description: "Follow-up po e-mailu, COLD lead, obtížnost 9", difficulty: "hard", avatar_initials: "AS", traits: ["Tichá", "Odměřená", "Strozá", "Uzavřená"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-marie-mrazkova", name: "Marie Mrázková", personality: "Nedůvěřivá paranoidní", description: "Follow-up po e-mailu, COLD lead, obtížnost 9", difficulty: "hard", avatar_initials: "MM", traits: ["Paranoidní", "Nedůvěřivá", "Odmítavá", "Podezřívavá"], elevenlabs_agent_id: "PLACEHOLDER" },
  { id: "agent-frantiska-jelinkova", name: "Františka Jelínková", personality: "Nedůvěřivá paranoidní", description: "Exspirace inzerátu, COLD lead, obtížnost 10", difficulty: "hard", avatar_initials: "FJ", traits: ["Paranoidní", "Odmítavá", "Agresivní", "Nedůvěřivá"], elevenlabs_agent_id: "PLACEHOLDER" },
];
...
async function run() {
  ...
  for (const aid of oldAgentIds) {
    await supabase.from("agents").delete().eq("id", aid);
  }
  
  console.log("=== Vkládání 19 nových agentů ===");
  for (const agent of agents) {
    const { error } = await supabase.from("agents").upsert(agent);
    if (error) {
      console.error(`Chyba u agenta ${agent.name}:`, error.message);
    } else {
  ...
  for (const scenario of scenarios) {
    ...
    if (error) {
      console.error(`Chyba u scénáře ${scenario.title}:`, error.message);
    } else {
  ...
  console.log("\n=== Hotovo! ===");
  console.log("DŮLEŽITÉ: Nahraďte všechna 'PLACEHOLDER' za skutečné ElevenLabs Agent IDs, pak spusťte znovu.");
}
