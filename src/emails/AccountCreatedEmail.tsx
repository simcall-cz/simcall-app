        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Section style={credentialsBoxStyle}>
              ...
              <table cellPadding={0} cellSpacing={0} style={{ width: "100%" }}>
                <tbody>
                  ...
                  <tr>
                    <td style={summaryLabelStyle}>Heslo</td>
                    <td style={{ ...summaryValueStyle, fontFamily: "monospace", fontSize: "15px", letterSpacing: "1px" }}>
                      {temporaryPassword}
                    </td>
                  </tr>
                </tbody>
            ...
            <Section style={ctaContainerStyle}>
              <Button style={ctaButtonStyle} href="https://simcall.cz/prihlaseni">
                Přihlásit se →
              </Button>
            </Section>
            ...
            <Section style={infoBoxStyle}>
              <Text style={{ fontSize: "14px", fontWeight: 600, color: "#171717", margin: "0 0 8px" }}>
                🔒 Chcete si změnit heslo?
              </Text>
              <Text style={{ fontSize: "13px", color: "#525252", lineHeight: "1.6", margin: "0 0 8px" }}>
                Doporučujeme si po prvním přihlášení změnit heslo. Stačí na přihlašovací
                stránce kliknout na <strong>&quot;Zapomněl/a jsem heslo&quot;</strong> a zadejte svůj e-mail.
                Přijde vám odkaz na nastavení nového hesla.
              </Text>
              <Text style={{ fontSize: "13px", color: "#525252", lineHeight: "1.6", margin: 0 }}>
                Nebo můžete heslo změnit přímo v nastavení vašeho profilu po přihlášení.
              </Text>
            </Section>
          </Section>
